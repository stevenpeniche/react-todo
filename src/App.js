          ...
          <Route exact path="/privacy-policy" render={() => {
              return (
                <div className="privacy-policy container is-fluid">
                  ...
                  <p>We collect your email information either through our sign up form or through facebook’s user authentication api and store it so you may login to the site and manipulate your created content</p>
